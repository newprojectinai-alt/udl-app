...
PAYLOAD = '{"title": "UDL Lesson", "scenes": [{"title": "Text Models: Computers & Language", "caption": "Computers need models to process our words.", "items": ["Text Model", "Computer Science", "Natural Language Process", "Understand Human Languag"], "duration": 6, "animation_type": "ionic_bond"}, {"title": "Layers of Text", "caption": "Text is understood layer by layer.", "items": ["Layers of Text Represent", "Bit stream", "Character encoding", "Syntax"], "duration": 6, "animation_type": "ionic_bond"}, {"title": "From Bits to Syntax", "caption": "Text starts as data, then forms words and sentences.", "items": ["Bit stream (0s and 1s)", "Character encoding (A, B", "Character sequence (word", "Syntax (sentence structu"], "duration": 6, "animation_type": "ionic_bond"}, {"title": "Deeper Meaning: Semantics", "caption": "Computers learn word meanings and relationships.", "items": ["Semantics (Word Meaning)", "Bag-of-Words, Word2Vec", "Knowledge (Concepts & Re", "Entity-Relation Graphs"], "duration": 6, "animation_type": "ionic_bond"}, {"title": "Cleaning Raw Text", "caption": "Raw documents need to be cleaned first.", "items": ["Text Preprocessing", "Text Extraction", "From PDF, DOCx, HTML", "To Plain Text"], "duration": 6, "animation_type": "ionic_bond"}, {"title": "Tokenization: Splitting Text", "caption": "Text is broken into smaller parts.", "items": ["Tokenization", "Split text into units", "Tokens: words, punctuati", "Example: \'Hello, world!\'"], "duration": 6, "animation_type": "ionic_bond"}, {"title": "Tokens: Building Blocks", "caption": "Tokens are key for language analysis.", "items": ["Tokens are fundamental", "Enable detailed analysis", "Count words, find patter", "Build language models"], "duration": 6, "animation_type": "ionic_bond"}], "width": 854, "height": 480}'
